            ...
            <div className="line">
              <div className="box" ref={(el) => (elementsRef.current[2] = el)}>
                ...
                <div className="txt">
                  ...
                  <p className="t3">예를 들어 3+3 횟수제 가입자가 3회 만난 후 환불 요청한다면 <br/>환불 금액은 얼마일까요? 놀랍게도 0원! <br/>+3은 서비스여서 환불 기준에서 제외되기 때문입니다.</p>
                  <p className="t3">550만 원짜리 기간제의 경우 500만 원짜리 약정 횟수 규약서와 50만 원짜리 기간 규약서를 두 장 쓰는 곳도 있습니다. 약정 횟수 이후 환불 시 환불 기준은 적은 금액의 기간제 규약서에 의해 진행되기에 환불금액이 매우 낮습니다.</p>
                </div>
              </div>
